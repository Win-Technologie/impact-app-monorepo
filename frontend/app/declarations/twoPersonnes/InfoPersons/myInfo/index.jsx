...
const MyInfo = () => {
    ...
    async function userInformation(idVehicule) {
        ...
        try {
            ...
            const result = await fetchUserInfoAndVehicle(idVehicule, userToken, ENDPOINT2);
    ...
    const consultInformation = (type) => {
        ...
        if (selectedVehicleId != null) {
            ...
            if (type == 1) {
                ...
                router.navigate("/declarations/twoPersonnes/InfoPersons/myInfo/personalInfo");
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", paddingBottom: 20 }}>
                ...
                <View>
                    <Text style={{ fontSize: 18, color: "#19363C", fontWeight: "bold" }}>Fournir mes informations</Text>
                </View>
            </View>
            <ScrollView>
                ...
                <View style={styles.qrContainer}>
                    {qrImageUri ? (
                        ...
                        <Text style={{ color: 'gray', fontSize:12 }}>Chargement du QR Code...</Text>
                    )}
