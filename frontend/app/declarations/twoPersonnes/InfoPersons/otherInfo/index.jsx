...
const OtherInfo = () => {
    ...
    const consultInformation = (type) => {
        ...
        if (type == 1) {
            ...
            router.navigate("/declarations/twoPersonnes/InfoPersons/otherInfo/personalInfo");

        } else if (type == 2) {

            router.navigate("/declarations/twoPersonnes/InfoPersons/otherInfo/vehicleInfo");

        } else if (type == 3) {

            router.navigate("/declarations/twoPersonnes/InfoPersons/otherInfo/assuranceInfo");
        }
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", paddingBottom: 20 }}>
                ...
                <View>
                    <Text style={{ fontSize: 18, color: "#19363C", fontWeight: "bold" }}>Reception des informations</Text>
                </View>
            </View>
            ...
            <ScrollView>
                ...
                <View style={styles.qrContainer}>
                    {isScannerActive ? (
                        ...
                        <TouchableOpacity onPress={() => setIsScannerActive(true)} style={styles.scanButton}>
                            <Text>{scannedData ? 'Scanner  un autre code QR' : 'Scanner le code QR'}</Text>
                        </TouchableOpacity>
                    )}
                ...
                <View style={styles.infoSection}>
                    <Text style={styles.sectionTitle}>Saisir  les informations manuellement</Text>
