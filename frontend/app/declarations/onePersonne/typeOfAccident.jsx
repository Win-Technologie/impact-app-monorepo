        ...
        if (!!selectedType) {
            ...
            if (selectedType === 'Autre') {
                ...
                if (!!accidentType) {
                    ...
                    Alert.alert('Erreur', "Vous devez inscrire le type d'accident avant de continuer", [
                        {
                            text: 'Ok',
                            onPress: () => null,
                            style: 'cancel',
                ...
                if (!!plateNumber) {
                    ...
                    Alert.alert('Erreur', "Vous devez inscrire le numéro de la carte d'immatriculation du vehicule touché", [
                        {
                            text: 'Ok',
                            onPress: () => null,
                            style: 'cancel',
            ...
            Alert.alert('Erreur', "Vous devez choisir  le type d'accident avant de continuer", [
                {
                    text: 'Ok',
                    onPress: () => null,
                    style: 'cancel',
        ...
        <SafeAreaView style={styles.outerContainer}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.container}>
                    ...
                    <Text style={styles.title}>De quel type d'accident  est-il question?</Text>
                    ...
                    <View style={styles.buttonContainer}>
                        ...
                        <AnimatedButton
                            ...
                            customStyle={selectedType === 'Accrochage avec un véhicule vide' ? styles.activeButton : styles.button}
                            textStyle={selectedType === 'Accrochage avec un véhicule vide' ? styles.activeButtonText : styles.buttonText}
                        />

                        <AnimatedButton
                            title="Accrochage d'un item public avec dommage"
                            onPress={() => handlePress("Accrochage d'un item public avec dommage")}
                            customStyle={selectedType === 'Accrochage d\'un item public avec dommage' ? styles.activeButton : styles.button}
                            textStyle={selectedType === 'Accrochage d\'un item public avec dommage' ? styles.activeButtonText : styles.buttonText}
                        />

                        <AnimatedButton
                            title="Accrochage d'un item public sans dommage"
                            onPress={() => handlePress("Accrochage d\'un item public sans dommage")}
                            customStyle={selectedType === 'Accrochage d\'un item public sans dommage' ? styles.activeButton : styles.button}
                            textStyle={selectedType === 'Accrochage d\'un item public sans dommage' ? styles.activeButtonText : styles.buttonText}
                        ...
                        <AnimatedButton
                            ...
                            customStyle={selectedType === 'Accrochage d\'un item privé' ? styles.activeButton : styles.button}
                            textStyle={selectedType === 'Accrochage d\'un item privé' ? styles.activeButtonText : styles.buttonText}
                        ...
                        <AnimatedButton
                            ...
                            customStyle={selectedType === 'Autre' ? styles.activeButton : styles.button}
                            textStyle={selectedType === 'Autre' ? styles.activeButtonText : styles.buttonText}
                        />
                    ...
                    {showAdditionalInput && (
                        <View >
                            <Text style={styles.title}>Information sur le véhicule touché</Text>
                    ...
                    { showAccidentTypeInput && (
                        <View >
                            <Text style={styles.title}>Informations sur le type d'accident</Text>
                            <View style={styles.inputWithCounter}>
                                <TextInput
                                    style={styles.textInput}
