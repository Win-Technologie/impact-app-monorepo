...
export default function VerifyEmail() {
    ...
    const showToastErrorToast = () => {
        ToastAndroid.showWithGravityAndOffset(
            "Code de validation  non valide ou expiré",
            ToastAndroid.LONG,
            ToastAndroid.BOTTOM,
            25,
            50,
    ...
    return (
        ...
        <SafeAreaView style={styles.container}>
            ...
            <TouchableOpacity style={{ flexDirection: "row", marginTop:30 }} onPress={() => { router.back() }}>
            ...
            <ScrollView>
                ...
                >
                    ...
                    <TouchableOpacity style={{ flexDirection: "row", justifyContent: 'center', marginTop: 20 }} onPress={resendCode}>
