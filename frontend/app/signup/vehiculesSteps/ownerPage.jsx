...
import { userInfoGatherState, lastVehicleState } from "../../../GlobalState/userDetailState";
...
export default function VehicleOwnership() {
   ...
   // console.log(vehicleDetails);
    ...
    const indexOfDefautCountryProvinces = () => {
        ...
        for (var i = 0; i < countryProvinces[vehicleDetails.vehicleOwnerCountry].length; i++) {

            if (countryProvinces[vehicleDetails.vehicleOwnerCountry][i] == vehicleDetails.vehicleOwnerProvince) {
    ...
    const createVehicleDetails = async () => {
        ...
        try {
            ...
            const formattedDetails = {
                ...
                immatriculation: {
                    numeroCertificatImmatriculation: vehicleDetails.vehicleNumeroCertificat,
           ...
           // console.log(formattedDetails);
            ...
            if (response.status != 201) {
                ...
                if (data.message == "Une voiture avec cette plaque d'immatriculation existe déjà.") {

                    //alert("Une voiture avec cette plaque d'immatriculation existe déjà.");

                    Alert.alert(t('error'), t('vehicleOwnership.acarwiththislicenseplatealreadyexists'), [
                ...
                if (progressData[1].actualstep == 2) {
                    ...
                    const array = progressData.map((item) => {
                        ...
                        if (item.id == 1) {
                            ...
                            return { id: 1, title: "Information du vehicules", subtitle: "8 minutes", completion: 1, actualstep: 3, nbstep: 3 };
        ...
        <SafeAreaView  style={styles.container}>
            ...
            <ScrollView style={styles.content}>
                ...
                <View style={styles.inputSection }>
                    ...
                    >
                        <Text style={isOwner ? styles.selectedButtonText : styles.unSelectedButtonText}>{t('vehicleOwnership.ownerOption1')}</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.inputSection}>
                    <TouchableOpacity
                        ...
                        style={!isOwner ? styles.selectedButton : styles.unSelectedButton}
                    >
                        <Text style={!isOwner ? styles.selectedButtonText : styles.unSelectedButtonText}>{t('vehicleOwnership.ownerOption2')}</Text>
                    </TouchableOpacity>
                </View>
                                    ...
                                    <Controller
                                        ...
                                        render={({ field: { onChange, onBlur, value } }) => (
                                            <TextInput
                                                ...
                                                value={value}
                                                placeholder={t('vehicleOwnership.postalCodePlaceholder')}
                                            />
                                        )}
                                    />
                                    ...
                                    <Controller
                                        ...
                                        render={({ field: { onChange, onBlur, value } }) => (
                                            ...
                                            <View>
                                                ...
                                                <SelectDropdown
                                                    defaultButtonText={t('vehicleOwnership.countryPlaceholder')}
                                                    defaultValueByIndex={vehicleDetails.vehicleOwnerCountry ? indexOfDefautContry() : null}
                                    ...
                                    <Controller
                                        ...
                                        render={({ field: { onChange, onBlur, value } }) => (
                                            ...
                                            <View>
                                                ...
                                                <SelectDropdown
                                                    defaultButtonText={t('vehicleOwnership.provincePlaceholder')}
                                                    defaultValueByIndex={vehicleDetails.vehicleOwnerProvince ? indexOfDefautCountryProvinces() : null}
