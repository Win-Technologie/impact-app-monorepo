        ...
        if (progressData[1].actualstep == 1) {
            ...
            const array = progressData.map((item) => {
                ...
                if (item.id == 1) {
                    ...
                    return { id: 1, title: "Information du vehicules", subtitle: "8 minutes", completion: 0, actualstep: 2, nbstep: 3 };
                    ...
                    <Controller
                        ...
                        render={({ field: { onChange, onBlur, value } }) => (
                            ...
                            <View>
                                ...
                                <View style={styles.dualtextInput}>
                                    <TextInput
                                    placeholder={t('vehicleRegistration.certificatePlaceholder')}
                                    style={[styles.textInputOfDual]}
                                        onBlur={onBlur}
                                        value={value} // Utiliser 'value' du contrôleur ici
                                        onChangeText={(text) => {
                ...
                <View style={styles.inputSection}>
                    <Controller
                        ...
                        render={({ field: { onChange, onBlur, value } }) => (
                            <>
                                <TextInput
                                placeholder={t('vehicleRegistration.dossierNumberPlaceholder')}
                    ...
                    <View style={{ flexDirection: "row", }}>
                        ...
                        <View style={{ flex: 1,  }}>
                            <Controller
                                ...
                                render={({ field: { onChange, value } }) => (
                                    <DatePickerInput
                                        ...
                                        onChange={(date) => {
                                            onChange(date);
                                            handleInputChange("vehicleCerticateDeliveryDate", date.toISOString().split('T')[0]);
                                        }}
                                        inputMode="start"
                                    />
                                )}
                            ...
                            {errors.dateDelivrance && (
                                <Text style={styles.errorText}>{errors.dateDelivrance.message}</Text>
                            )}
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={{ flexDirection: "row", }}>
                            ...
                            <View style={{ flex: 1 }}>
                                <Controller
                                    ...
                                    render={({ field: { onChange, value } }) => (
                                        <DatePickerInput
                                            ...
                                            onChange={(date) => {
                                                onChange(date);
                                                handleInputChange("vehicleCerticateExpirationDate", date.toISOString().split('T')[0]);
                                            }}
                                            inputMode="start"
                                        />
                                    )}
                                ...
                                {errors.dateExpiration && (
                                    <Text style={styles.errorText}>{errors.dateExpiration.message}</Text>
                                )}
                        </View>
                    </View>
                </View>
                        ...
                        <View style={{ flex: 1, marginRight: 10 }}>
                            <Controller
                                ...
                                render={({ field: { onChange, onBlur, value } }) => (
                                    <>
                                        <TextInput
                                        placeholder={t('vehicleRegistration.netWeightPlaceholder')}
                                        style={styles.textInput}
                                            onBlur={onBlur}
                                            value={value}
                                            onChangeText={(text) => {
                            ...
                            <Controller
                                ...
                                render={({ field: { onChange, onBlur, value } }) => (
                                    <>
                                        <TextInput
                                            style={styles.textInput}
                                            placeholder={t('vehicleRegistration.usageCategoryPlaceholder')}
                                            onBlur={onBlur}
                                            value={value}
                                            onChangeText={(text) => {
                            ...
                            <Controller
                                ...
                                render={({ field: { onChange, onBlur, value } }) => (
                                    <>
                                        <TextInput
                                            style={styles.textInput}
                                            placeholder={t('vehicleRegistration.axleNumberPlaceholder')}
                                            onBlur={onBlur}
                                            value={value}
                                            onChangeText={(text) => {
                                        ...
                                        {errors.numeroEssieux && (
                                            <Text style={styles.errorText}>{errors.numeroEssieux.message}</Text>
                                        )}
                                    </>
                                )}
                            />
