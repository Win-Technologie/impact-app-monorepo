...
export default function SignUpLandingPage() {
  ...
  async function signout() {
    Alert.alert(
      "Attention",
      "Voulez-vous vraiment abandonder le processus de recolte d'informations d'inscription",
      [
        {
          text: "Non",
    ...
    return (
      <View style={{ marginBottom: 100 }}>
        <Text style={styles.MainTitle}>
          {t("signUpLandingPage.documentScanTitle")}
        </Text>
        <View style={{ flexDirection: "row" }}>
          ...
          >
            <View style={styles.innerBox}>
              ...
              <Text style={styles.title}>
                {t("signUpLandingPage.driverLicense")}
              </Text>
              <Text style={styles.description}>
                {t("signUpLandingPage.scanDriverLicense")}
              </Text>
              <View style={styles.bottomLine}>
                <Text style={{ color: "white" }}>
                  {t("signUpLandingPage.scanButton")}
                </Text>
              </View>
            </View>
          </TouchableOpacity>
          ...
          >
            <View style={styles.innerBox}>
              ...
              <Text style={styles.title}>
                {t("signUpLandingPage.insurancePapers")}
              </Text>
              <Text style={styles.description}>
                {t("signUpLandingPage.scanInsurancePapers")}
              </Text>
              <View style={styles.bottomLine}>
                <Text style={{ color: "white" }}>
                  {t("signUpLandingPage.scanButton")}
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
      <View style={styles.container}>
        <FlatList
          ...
          ListHeaderComponent={
            <Text style={styles.MainTitle}>
              {t("signUpLandingPage.headerTitle")}
            </Text>
          }
        ...
        <View style={styles.bottomButtonContainer}>
          ...
          >
            <Text style={styles.buttonText}>
              {t("signUpLandingPage.cancelButton")}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
