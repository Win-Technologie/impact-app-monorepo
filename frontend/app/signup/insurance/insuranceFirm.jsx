import { StyleSheet, Text, View, Button, KeyboardAvoidingView, TouchableOpacity ,Platform, ScrollView, TextInput } from 'react-native';
...
export default function InsuranceStageTwo() {
    ...
    const indexOfDefautCountryProvinces = () => {
        ...
        for (var i = 0; i < countryProvinces[insuranceDetails.insuranceFirmCountry].length; i++) {

            if (countryProvinces[insuranceDetails.insuranceFirmCountry][i] == insuranceDetails.insuranceFirmProvince) {
        ...
        if (progressData[2].actualstep == 1) {
            ...
            const array = progressData.map((item) => {
                ...
                if (item.id == 2) {
                    ...
                    return { id: 2, title: t("insuranceFirm.firmTitle"), subtitle: "8 minutes", completion: 0, actualstep: 2, nbstep: 3 };
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.content}>
                ...
                <View style={styles.inputSection}>
                    ...
                    />
                    {errors.insuranceName && <Text style={styles.errorText}>{errors.insuranceName.message}</Text>}
                </View>
                            ...
                            <Controller
                                ...
                                render={({ field: { onChange, onBlur, value } }) => (
                                    ...
                                    <View>
                                        ...
                                        <SelectDropdown
                                              defaultButtonText={t('insuranceFirm.firmCountryPlaceholder')}
                                              defaultValueByIndex={insuranceDetails. insuranceFirmCountry ? indexOfDefautContry() : null}
                                ...
                                render={({ field: { onChange, onBlur, value } }) => (
                                    ...
                                    <View>
                                        ...
                                        <SelectDropdown
                                            ...
                                            defaultValueByIndex={insuranceDetails. insuranceFirmProvince ? indexOfDefautCountryProvinces() : null}
