...
import { expirationDateState, insuranceCompanyState, policyNumberState, insuranceInfoState, userVehicleState } from '../../../GlobalState/InsuranceState';
...
export default function InsuranceStageThree() {
    ...
    const indexOfDefautCountryProvinces = () => {
        ...
        for (var i = 0; i < countryProvinces[insuranceDetails.vehicleOwnerCountry].length; i++) {

            if (countryProvinces[insuranceDetails.vehicleOwnerCountry][i] == insuranceDetails.vehicleOwnerProvince) {
    ...
    const addInsurance = async () => {
        ...
        try {
            const result = await addNewInsurances(insuranceInfo, vehiculeUser, ENDPOINT, userToken);
            console.log(result);
                ...
                if (progressData[2].actualstep == 2) {
                    ...
                    const array = progressData.map((item) => {
                        ...
                        if (item.id == 2) {
                            ...
                            return { id: 2, title: "Informations d'assurances", subtitle: "8 minutes", completion: 1, actualstep: 3, nbstep: 3 };
            ...
            if (result.status === 400) {
                result.data.error ? setMessageErrorServer(result.data.error) : setMessageErrorServer(result.data.message)
            }
        } catch (error) {
            alert(error)
        }
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.content}>
                ...
                <View style={styles.inputSection}>
                    ...
                    >
                        <Text style={isOwner ? styles.selectedButtonText : styles.unSelectedButtonText}>{t('insurance.ownerOption')}</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.inputSection}>
                    <TouchableOpacity
                        ...
                        style={!isOwner ? styles.selectedButton : styles.unSelectedButton}
                    >
                        <Text style={!isOwner ? styles.selectedButtonText : styles.unSelectedButtonText}>{t('insurance.notOwnerOption')}</Text>
                    </TouchableOpacity>
                </View>
                                        ...
                                        render={({ field: { onChange, onBlur, value } }) => (
                                            ...
                                            <View>
                                                ...
                                                <SelectDropdown
                                                    ...
                                                    defaultValueByIndex={insuranceDetails.insuranceOwnerCountry ? indexOfDefautContry() : null}
                                        ...
                                        render={({ field: { onChange, onBlur, value } }) => (
                                            ...
                                            <View>
                                                ...
                                                <SelectDropdown
                                                    ...
                                                    defaultValueByIndex={insuranceDetails.insuranceOwnerProvince ? indexOfDefautCountryProvinces() : null}
