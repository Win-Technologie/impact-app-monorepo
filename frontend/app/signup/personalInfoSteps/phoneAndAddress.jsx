        ...
        if (progressData[0].actualstep == 2) {
            ...
            const array = progressData.map((item) => {
                ...
                if (item.id == 0) {
                    ...
                    return { id: 0, title: "Information personnelles", subtitle: "4 minutes", completion: 0, actualstep: 3, nbstep: 4 };
                ...
                <View style={styles.inputSection}>
                    <Controller
                        ...
                        rules={{
                            ...
                            minLength: { value: 4, message: t('phoneAndAddress.fourcarminimum') }
                        }}
                            ...
                            render={({ field: { onChange, onBlur, value } }) => (
                                ...
                                <View>
                                    ...
                                    <SelectDropdown
                                        ...
                                        defaultValueByIndex={userDetails.country ? indexOfDefautContry() :null}
                            ...
                            render={({ field: { onChange, onBlur, value } }) => (
                                ...
                                <View>
                                    ...
                                    <SelectDropdown
                                        ...
                                        defaultValueByIndex={userDetails.province ? indexOfDefautCountryProvinces() : null}
