...
const AccidentTypePage = () => {
  ...
  const handlePress = (type) => {
    ...
    setShowAdditionalInput(
      type === t("accidentTypes.vehicleCollisionWithEmptyVehicle"),
    );
        ...
        <View style={styles.container}>
          ...
          <View style={styles.buttonContainer}>
            <AnimatedButton
              ...
              onPress={() =>
                handlePress(t("accidentTypes.vehicleCollisionWithEmptyVehicle"))
              }
              customStyle={
                selectedType ===
                t("accidentTypes.vehicleCollisionWithEmptyVehicle")
                  ? styles.activeButton
                  : styles.button
              }
              textStyle={
            ...
            <AnimatedButton
              ...
              onPress={() =>
                handlePress(t("accidentTypes.publicItemCollisionWithDamage"))
              }
              customStyle={
                selectedType ===
                t("accidentTypes.publicItemCollisionWithDamage")
                  ? styles.activeButton
                  : styles.button
              }
              textStyle={
            ...
            <AnimatedButton
              ...
              onPress={() =>
                handlePress(t("accidentTypes.publicItemCollisionWithoutDamage"))
              }
              customStyle={
                selectedType ===
                t("accidentTypes.publicItemCollisionWithoutDamage")
                  ? styles.activeButton
                  : styles.button
              }
              textStyle={
            ...
            <AnimatedButton
              ...
              onPress={() =>
                handlePress(t("accidentTypes.privateItemCollision"))
              }
              customStyle={
          ...
          {showAccidentTypeInput && (
            <View style={styles.additionalInputContainer}>
              <Text style={styles.additionalTitle}>
                {t("accidentTypes.accidentTypeInfo")}
              </Text>
              <View style={styles.inputWithCounter}>
                <TextInput
                  style={styles.textInput}
                ...
                <View style={styles.additionalInputContainer}>
                  ...
                  <View style={styles.inputWithCounter}>
                    <TextInput
                      ...
                      value={plateNumber}
                      onChangeText={(text) =>
                        setPlateNumber(text.substring(0, 7))
                      }
                    />
                    <Text
                      style={styles.counter}
                    >{`${plateNumber.length}/7`}</Text>
                  </View>
                </View>
              )}
              {showAccidentTypeInput && (
