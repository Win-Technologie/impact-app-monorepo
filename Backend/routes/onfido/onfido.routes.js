...
router.post(
  "/applicants",
  [userAuth.ensureAuth],
  onfidoController.createApplicant,
);
...
router.get(
  "/applicants/:email",
  [userAuth.ensureAuth],
  onfidoController.getApplicantByEmail,
);
...
router.delete(
  "/applicants/:email",
  [userAuth.ensureAuth],
  onfidoController.deleteApplicantByEmail,
);
...
router.get(
  "/applicants",
  [userAuth.ensureAuth],
  onfidoController.getAllApplicants,
);

// Route pour vérifier le permis de conduire d'un demandeur Onfido
router.post(
  "/applicants/driving_license",
  onfidoController.verifyDrivingLicense,
);
