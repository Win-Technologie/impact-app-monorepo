...
const md_uploadAccidentRepportImg = multiparty({
  uploadDir: `${USER_ROUTER_IMG_ACCIDENT_REPPORT_PATH}`,
});
...
router.post(
  "/report/new",
  [userAuth.ensureAuth, md_uploadAccidentRepportImg],
  accidentController.newAccidentReport,
);
...
router.get(
  "/report/:id",
  [userAuth.ensureAuth],
  accidentController.getAccidentReport,
);
...
router.patch(
  "/update/:accidentId",
  [userAuth.ensureAuth, md_uploadAccidentImg],
  accidentController.updateAccidentReport,
);
...
router.post(
  "/report/join",
  [userAuth.ensureAuth],
  accidentController.joinToAccidentReport,
);
...
router.get(
  "/accidentReports",
  [userAuth.ensureAuth],
  accidentController.getUserAccidentReports,
);
...
router.get(
  "/accidentDetails",
  [userAuth.ensureAuth],
  accidentController.getUserAccidentDetails,
);
