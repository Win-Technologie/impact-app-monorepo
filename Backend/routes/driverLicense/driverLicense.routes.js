...
router.post(
  "/user/license",
  userAuth.ensureAuth,
  driverLicenseController.createDrivingLicence,
);
...
router.get(
  ...
  driverLicenseController.GetMyLicense,
);
...
router.get(
  "/user/license",
  [userAuth.ensureAuth, userAuth.isActiveSession],
  driverLicenseController.GetDrivingLicense,
);
...
router.delete(
  "/user/license",
  [userAuth.ensureAuth, userAuth.isActiveSession],
  driverLicenseController.DeleteDrivingLicense,
);
