...
const md_uploadInsuranceImg = multiparty({
  uploadDir: `${INSURANCE_ROUTER_IMG_PATH}`,
});
...
router.get(
  "/vehicle/:vehicleId",
  [userAuth.ensureAuth],
  insuranceController.getInsuranceByVehicleId,
);
...
router.get(
  "/user/:userId",
  [userAuth.ensureAuth],
  insuranceController.getInsuranceByUserId,
);
