...
async function generatePDF(reportData) {
  ...
  page.drawText(
    `Date de l'accident : ${reportData.accidentDate.toDateString()}`,
    {
      x: 50,
      y: yPosition,
      size: fontSize,
  ...
  reportData.vehicles.forEach((vehicle, index) => {
    ...
    page.drawText(
      `Propriétaire : ${vehicle.personalDetails.name} ${vehicle.personalDetails.lastName}`,
      {
        x: 50,
        y: yPosition,
        size: fontSize,
    ...
    page.drawText(
      `Adresse : ${vehicle.personalDetails.address}, ${vehicle.personalDetails.city}, ${vehicle.personalDetails.province}, ${vehicle.personalDetails.country}`,
      {
        x: 50,
        y: yPosition,
        size: fontSize,
    ...
    page.drawText(
      `Véhicule : ${vehicle.vehicleDetails.registrationCertificate.vehicleBrand}, ${vehicle.vehicleDetails.registrationCertificate.year}`,
      {
        x: 50,
        y: yPosition,
        size: fontSize,
    ...
    page.drawText(
      `Numéro d'immatriculation : ${vehicle.vehicleDetails.registrationCertificate.licensePlateNumber}`,
      {
        x: 50,
        y: yPosition,
        size: fontSize,
    ...
    page.drawText(
      `Compagnie d'assurance : ${vehicle.vehicleDetails.insuranceCertification.insuranceCompany}`,
      {
        x: 50,
        y: yPosition,
        size: fontSize,
