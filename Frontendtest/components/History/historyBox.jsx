...
export default function HistoryBoxComponent({ date, description, people, accidentImageUri, width = 335, height = 200, style }) {
  // Styles combinés pour le composant de la boîte
  const boxStyles = [styles.box, { width, height }, style];
