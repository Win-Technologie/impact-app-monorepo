        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 20, }}>
                <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => { router.back() }}>
                    <AntDesign name='arrowleft' size={20} color="#19363C" style={{ fontWeight: "200" }} /><Text style={{ color: "#19363C" }}>{"   "}{t('back')}</Text>
                </TouchableOpacity>
            </View>

            <View style={{ marginTop: 80, marginBottom:10 }}>
                <Text style={{ color: "#19363C", fontSize: 18, fontWeight: 600 }}>{t('language')}</Text>
            </View>
            ...
            <View>
                ...
                <View style={{
                    ...
                    marginVertical: 10, borderBottomWidth: 1, borderBottomColor: "gray"
                }}>
                    <View>
                        <Text>{t('french')}</Text>
                    </View>
