...
const otherspecification = () => {
    ...
    const next = () => {
        ...
        setDeclaration({ ...declaration, otherSpecification: otherSpec, images: images });
    ...
    return (
        ...
        <SafeAreaView style={styles.outerContainer}>
            ...
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.title}>Avez-vous d'autre spécifications à ajouter ?</Text>
                ...
                <View style={styles.inputSection}>
                    <View style={{ padding: 2, alignItems: 'center', marginVertical: 0, justifyContent: 'center' }}>
                        <TouchableOpacity style={styles.UploadButton} onPress={() => { openPickupImage() }}>
                        
                            <SimpleLineIcons name="cloud-upload" size={24} color="#1B6878" />
                                
                            <Text style={{ textAlign:"center" }}>Telecharger une photo de <Text style={{ color: "#0B7BA8" }}>l'accident </Text> ou du
                                <Text style={{ color: "#0B7BA8" }}> véhicule </Text> au moment de l'accident'
                            </Text>
                        </TouchableOpacity>
                    </View>
                </View>
                    ...
                    images.map((image) =>
                        ...
                        <View key={image.id} style={{
                            ...
                            <TouchableOpacity onPress={() => { removeImage(image) }} >
                                <Text style={{ color: 'white' }}> <Ionicons name="close-circle-sharp" size={18} color="white" /> </Text>
                            </TouchableOpacity>
