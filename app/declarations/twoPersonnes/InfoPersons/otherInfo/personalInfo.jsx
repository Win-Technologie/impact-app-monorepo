import { StyleSheet, Text, View, Button, KeyboardAvoidingView, Platform, ScrollView, TextInput, TouchableOpacity, ActivityIndicator } from 'react-native';
...
export default function PersonanalInformation() {
    ...
    */
    ...
    const handlePressContinue = () => {
        router.navigate('/declarations/twoPersonnes/InfoPersons/myInfo/vehicleInfo');
    };
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", paddingVertical: 20 }}>
                ...
                <View>
                    <Text style={{ fontSize: 18, color: "#19363C", fontWeight: "bold" }}> Informations personnelles</Text>
                </View>
            ...
            <ScrollView keyboardShouldPersistTaps='handled'>
                <View style={styles.contentContainer}>
                    {!userData ? <Loading text='Loading..' /> : <InputsShowGroup dataToShow={userData} editable={true} />}
                </View>
            </ScrollView>
