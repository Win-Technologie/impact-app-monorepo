        ...
        for (var i = 0; i < person; i++) {
            ...
            if (i == 0) {
                ...
                tab=  [...tab, {
                    ...
                    description: "Fournissez vos informations aux autres individus impliqués grâce à votre code QR ou en fournissant manuellement vos données personnelles.",
                ...
                tab= [...tab, {
                    ...
                    description: "Recevez les informations des autres individus impliqués en scannant leur code QR ou en rentrant manuellement leurs données personnelles.",
            ...
            <TouchableOpacity style={styles.box} onPress={() => { goTo(item.number) } }>
                    ...
                    <View style={{ paddingBottom: 10, flexDirection: "row", justifyContent: "space-between" }}>
                        <Text style={{ fontSize: 18, color: "#19363C", fontWeight: "bold" }}>{item.title}</Text>
                        {
                            ...
                            <View style={{ width: 25, height: 25, backgroundColor: "#CF8C58", borderRadius: 5, justifyContent: "center", alignItems: "center" }}>
                                {item.number > 0 && <Text style={{ color: "#fff" }}>{item.number}</Text>}
                            </View>
                        }
                ...
                <View style={styles.boxFooter}>
                    <View style={{ flexDirection:"row" }}>
                        <Text style={{ color: "#FFFFFF", fontWeight: "400", fontSize: 14, }}>{item.subtitle} {"  "}
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", paddingBottom: 20, alignItems: "center" }}>
                ...
                <View>
                    <Text style={{ fontSize: 18, color: "#19363C", fontWeight: "bold" }}>Informations de base</Text>
                </View>
            </View>
            ...
            <View style={styles.footContainer}>
                <TouchableOpacity onaPress={ next} style={{ backgroundColor: "#0B8BA8", height: 50, flexDirection: "row", alignItems: "center", justifyContent: "center" }}>
                    <Text style={{ color: "#FFFFFF", fontSize: 16, fontWeight:500 }} > Continuer </Text>
                </TouchableOpacity>
            </View>
