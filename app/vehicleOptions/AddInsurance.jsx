...
const AddInsurance = () => {
    ...
    const handleSubmit = async () => {
        ...
        const result = await addNewInsurances(insuranceData, selectedVehicleId, 'insurances/add/', token);
        ...
        if (result.error) {
            ...
            Alert.alert(t('common.error'), result.message || t('common.unknownError'));
        }
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", paddingVertical: 20, alignItems: "center" }}>
                ...
                <View>
                    <Text style={{ fontSize: 18, color: "#19363C", fontWeight: "bold" }}>{t('addInsurance.title')}</Text>
                </View>
            </View>
