import { StyleSheet, Text, View, Button, KeyboardAvoidingView, Platform, ScrollView,  TextInput, Pressable, TouchableOpacity, Modal } from 'react-native';
        ...
        if (progressData[2].actualstep == 0) {
            ...
            const array = progressData.map((item) => {
                ...
                if (item.id == 2) {
                    ...
                    return { id: 2, title: "Informations d'assurances", subtitle: "8 minutes", completion: 0, actualstep: 1, nbstep: 3 };
    ...
    async function requestUserVehicles() {
        ...
        try {
            ...
            if (response.status === 200) {
                const vehicles = response.data.carsWithInsurances.map(asset => ({ id: asset.car._id, model: asset.car.model }));
            ...
            <ScrollView style={styles.content}>
                ...
                <View style={styles.inputSection}>
                    ...
                    <SelectDropdown
                        ...
                        buttonStyle={[styles.dropdown1BtnStyle, /*{ borderColor: errorVehicleState ? 'red' : '#ccc' }*/]}
                    ...
                    {!insuranceDetails.idCar && submit  && <Text style={styles.errorText}>{t('insurance.vehicleRequired')}</Text>}
                </View>
                                ...
                                <>
                                    <DatePickerInput
                                        ...
                                        onChange={(d) => {
                                          onChange(d);
                                          setInputDate(d);
                                          handleInputChange("insuranceExpirationDate", d.toISOString().split('T')[0]);
                                        }}
                                        inputMode="start"
