...
import { userDetailsState, licenceScanState } from "../../../GlobalState/userDetailState";
...
export default function ScanPermis() {
    ...
    const handlePressContinue = async () => {
        ...
        if (!rectoImage || !versoImage || !selfie) {
            ...
            Alert.alert('Incomplet', 'Vous devez uploader toutes les photos requises avant de continuer.', [
                {
                    text: 'Ok',
                    onPress: () => { },
                    style: 'cancel',
            ...
            try {
               ...
               // console.log(userData);
                ...
                //console.log(userData);
                /*if (userData.msg == "Nouvelle licence ajoutée avec succès") {
        ...
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <View style={{ padding: 2, alignItems: 'center', justifyContent: 'center' }}>
                    <TouchableOpacity style={styles.UploadButton} onPress={() => { openPickupImage(1) }}>
                        {
                            !rectoImage ?
                        ...
                        <Text style={styles.text}>Telecharger une photo du <Text style={{ color: "#0B7BA8" }}>recto</Text> de votre permis </Text>
                    </TouchableOpacity>
                </View>

                

                <View style={{ padding: 2, alignItems: 'center', marginVertical: 20, justifyContent: 'center' }}>
                    <TouchableOpacity style={styles.UploadButton} onPress={() => { openPickupImage(2) }}>
                        {
                            !versoImage ?
                            <SimpleLineIcons name="cloud-upload" size={24} color="#1B6878" />
                            :
                        ...
                        <Text style={styles.text}>Telecharger une photo du <Text style={{ color: "#0B7BA8" }}>verso</Text> de votre permis </Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{ padding: 2, alignItems: 'center', justifyContent: 'center', width: "100%" }}>
                    <TouchableOpacity style={styles.UploadButton} onPress={() => { openPickupImage(3) }}>
                        {
                            !selfie ?
                                <SimpleLineIcons name="cloud-upload" size={24} color="#1B6878" />
                                :
                        ...
                        <Text style={styles.text}>Telecharger votre <Text style={{ color: "#0B7BA8" }}>selfie</Text> </Text>
                    </TouchableOpacity>
                </View>
