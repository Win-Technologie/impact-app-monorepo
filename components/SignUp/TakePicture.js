        ...
        return (
            ...
            >
                ...
                <View style={{ flex: 1, backgroundColor: "black", flexDirection: "row" }}>
                    ...
                    <TouchableOpacity onPress={__retakePicture} style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={{ color: "#fff" }}>Réssayer</Text>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={__validatePicture} style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
