        ...
        <View style={styles.container}>
            {dataToShow.map((item, key) => {
                if (item.style === 'column') {
                    return <InputTextShow key={key} label={item.label} info={item.value} editable={editable} />
                } else if (item.style === 'row') {
                    return (
                        <View style={styles.inputInfoRow} key={key}>
                            <View style={styles.inputInfoRowFirstChildren}>
                                <InputTextShow label={item.firstLabel} info={item.valueFirstLabel} editable={editable} />
                            </View>
                            <View style={styles.inputInfoRowSecondChildren}>
                                <InputTextShow label={item.secondLabel} info={item.valueSecondLabel} editable={editable} />
                            </View>
                        </View>
                    );
                    ...
                    return (
                        <View style={styles.inputInfoRow} key={key}>
                            <View style={styles.inputInfoRowFirstChildren}>
                                <DropdownInputShow label={item.firstLabel} info={item.valueFirstLabel} />
                            </View>
                            <View style={styles.inputInfoRowSecondChildren}>
                                <DropdownInputShow label={item.secondLabel} info={item.valueSecondLabel} />
                            </View>
                        </View>
                    );
                }
